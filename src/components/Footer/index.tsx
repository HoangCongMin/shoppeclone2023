  ...
  return (
    <div className='w-full  pb-8 '>
      <div className='m-auto mt-8 w-4/5 max-w-screen-2xl'>
        <div className='flex w-full justify-between text-gray-500 max-[1000px]:flex-col	'>
          <div className='text-sm	'>{t('AsideFiller.titleLanGue')}</div>
          <div className='text-sm	'>
            {t('AsideFiller.Country & Region')}: {t('AsideFiller.address')}
          </div>
        </div>
        <div className='mt-10 w-full	text-center text-sm text-gray-500 max-[1000px]:text-left'>
