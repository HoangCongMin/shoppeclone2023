...
export default function Header() {
  ...
  const Mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.removeQueries({ queryKey: ['ListItem', { status: purchases.incart as Purchasesstatusall }] })
    }
  })
      ...
      <div className='w-[35%]'>
        <ul className='flex w-full justify-between text-[14px] text-white'>
          <li className='flex items-center'>
            <FiBell />
            <p className='ml-1'> Thông báo </p>
          </li>
          <li className='flex items-center'>
            <AiOutlineQuestionCircle /> <p className='ml-1'> Hỗ trợ </p>
          </li>
          <Popoper
            consomer={
              <div className='relative h-16 w-52 bg-white'>
                ...
                <div className='m-auto w-4/5'>
                  <p className='cursor-pointer pt-2 text-[13px] hover:text-orange'>Tiếng việt</p>
                  <p className='cursor-pointer pt-2 text-[13px] hover:text-orange'>Tiếng Anh</p>
                </div>
              </div>
            }
          >
            <AiOutlineGlobal /> <p className='ml-1'> Tiếng việt</p> <MdOutlineKeyboardArrowDown />
          </Popoper>
          {LoginAndRegister && (
            <Popoper
              consomer={
                <div className='relative w-40 bg-white'>
                  ...
                  />
                  <div className='m-auto w-4/5'>
                    <Link to={Path.Proflie} className='cursor-pointer pt-2 text-[13px] hover:text-orange'>
                      Trang cá nhân
                    </Link>
            ...
            >
              <svg
                className='h-4	w-4	rounded-2xl bg-black'
