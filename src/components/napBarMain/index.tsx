...
const registerschema = schema.pick(['search'])
...
export default function NapBarMain() {
  ...
  // const ma=  queryClient.invalidateQueries({ queryKey: ['purchases', { status: purchases.incart }] })
  // console.log(ma)
  ...
  const handlesrearc = handleSubmit((data) => {
  ...
  return (
    <div className='w-full bg-orange'>
      ...
      <div className='m-auto flex w-10/12 max-w-screen-2xl justify-between pt-5 pb-1'>
        <div className='w-56'>
          <Link to={Path.Home}>
            <svg viewBox='0 0 192 65' className='h-8 w-40	 fill-white lg:h-11'>
              <g fillRule='evenodd'>
        ...
        <div className='w-9/12	'>
          <form onSubmit={handlesrearc} className='flex items-center bg-white px-1	py-1'>
            <input {...register('search')} className='h-8 w-11/12 px-2 outline-none' type='text' placeholder='search' />
            <button type='submit' className='flex h-8 w-1/12 flex-col items-center bg-orange pt-2'>
        ...
        <div className='flex	 w-40 flex-col items-center justify-center text-white'>
          <Popoper
            consomer={
              <div className='w-[400px] rounded-sm border-[1px] border-solid border-slate-200	bg-white'>
                <span
                  ref={arowref}
                  className=' absolute left-[12.5rem]  -translate-y-5 border-[11px] border-x-transparent border-t-transparent 	border-b-white'
                  style={{ left: middlewareData.arrow?.x, top: middlewareData.arrow?.y }}
                />
                  ...
                  <div className='pt-1'>
                    {data?.data.data?.slice(0, itemDisplay).map((item) => (
                      <div key={item.product._id} className='mt-4 flex items-center justify-between'>
                        <img
                          className='w-[15%] border-[1px] border-solid		border-inherit'
          ...
          >
            <FiShoppingCart className='h-7 w-7 fill-white' />
          </Popoper>
        </div>
      </div>
    </div>
